 ...
 * *******************************************************************
 */
public abstract class AbstractStreamResult extends StrutsResultSupport {

	protected static final long serialVersionUID = -1468409635999059850L;
	protected static Logger LOG = LoggerFactory.getLogger(AbstractStreamResult.class);
	...
	public AbstractStreamResult() {
		super();
	}

	public AbstractStreamResult(InputStream in) {
        this.inputStream = in;
    }
	
	public AbstractStreamResult(File in) {
		this.inputFile = in;
	}
	
	public AbstractStreamResult(String in) {
		this.inputFilePath = in;
	}
	
	public AbstractStreamResult(byte[] in) {
		this.inputBytes = in;
	}
